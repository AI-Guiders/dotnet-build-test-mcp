...
- Парсеры вывода `dotnet build` / `dotnet test` — NuGet-пакет **[AIGuiders.DotNetBuildTestParsers](https://www.nuget.org/packages/AIGuiders.DotNetBuildTestParsers)** ([исходники](https://github.com/KarataevDmitry/dotnet-build-test-parsers)).
